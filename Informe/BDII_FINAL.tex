...
\begin{figure}[H]
	\begin{Center}
		\includegraphics[width=5.91in,height=3.08in]{./media/figura1.png}
	\end{Center}
\end{figure}
...
Este diagrama de secuencia, grafica de manera técnica la secuencia de actividades que realizara el sistema de acuerdo con los casos de uso.
%%%%%%%%%%%%%%%%%%%% Figure/Image No: 2 starts here %%%%%%%%%%%%%%%%%%%%

\begin{figure}[H]
	\begin{Center}
		\includegraphics[width=5.91in,height=4.11in]{./media/diagrama_secuencia.png}
	\end{Center}
\end{figure}
