...
\par
	...
	\item Diagrama de secuencia \par
...
\begin{figure}[H]
	\begin{Center}
		\includegraphics[width=6in,height=3.8in]{./media/DSagregarUsu.jpg}
	\end{Center}
\end{figure}
...
\begin{figure}[H]
	\begin{Center}
		\includegraphics[width=6in,height=4in]{./media/DSmodificarEjemplar.jpg}
	\end{Center}
\end{figure}
...
\begin{figure}[H]
	\begin{Center}
		\includegraphics[width=6in,height=5in]{./media/dActvidad.jpg}
	\end{Center}
\end{figure}
...
\vspace{\baselineskip}
Esta Prueba Unitaria corresponde a la clase Autor. Esta prueba unitaria pone a prueba el metodo "CrearAutor()" declarado en la clase.

%%%%%%%%%%%%%%%%%%%% Figura / Imagen No: 5 comienza aquí %%%%%%%%%%%%%%%%%%%%

\begin{figure}[H]
	\begin{Center}
		\includegraphics[width=5.91in,height=3.01in]{./media/pruebaU1.jpg}
	\end{Center}
\end{figure}


%%%%%%%%%%%%%%%%%%%% Figura / Imagen No: 5 Termina aquí %%%%%%%%%%%%%%%%%%%%
\newpage
...
%%%%%%%%%%%%%%%%%%%% Figura / Imagen No: 6 comienza aquí %%%%%%%%%%%%%%%%%%%%

\begin{figure}[H]
	\begin{Center}
		\includegraphics[width=5.91in,height=2.15in]{./media/pruebaU2.jpg}
	\end{Center}
\end{figure}


%%%%%%%%%%%%%%%%%%%% Figura / Imagen No: 6 Termina aquí %%%%%%%%%%%%%%%%%%%%
	\item MAPEO
...
\begin{figure}[H]
	\begin{Center}
		\includegraphics[width=5.91in,height=1.95in]{./media/autorMap.jpg}
	\end{Center}
\end{figure}
...
\begin{figure}[H]
	\begin{Center}
		\includegraphics[width=5.91in,height=2.15in]{./media/categoriaMap.jpg}
	\end{Center}
\end{figure}
